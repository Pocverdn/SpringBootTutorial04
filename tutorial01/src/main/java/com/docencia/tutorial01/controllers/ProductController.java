...
public class ProductController {
    ...
    private static final List<Map<String, String>> products = new ArrayList<>(List.of(
        ...
        Map.of("id", "3", "name", "Chromecast", "description", "Best Chromecast", "price", "80"),
        Map.of("id", "4", "name", "Glasses", "description", "Best Glasses", "price", "50")
    ));
    ...
    public String show(@PathVariable String id, Model model) {
        ...
        int productPrice = Integer.parseInt(product.get("price"));
